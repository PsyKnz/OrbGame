...
public class GameUi extends InputAdapter {
	...
	public final Array<UiElement> messageStack;	// Stack of all messages generated by this screen.
	...
	public GameUi(PlayScreen scr, InputMultiplexer input) {
		this.input = input;
		manager = new TweenManager();
		this.screen = scr;
		messageStack = new Array<UiElement>();
	...
	public void setCamera(OrthographicCamera camera) {
		...
		for(UiElement msg : messageStack) msg.setCamera(camera);
	}
	...
	public void draw(SpriteBatch batch) {
		...
		for(UiElement msg : messageStack) msg.draw(batch); // Draws all onscreen messages.
	}
	...
	public void removeMessage(UiElement message) {
	...
	public void displayMainMenu() {
		MainMenu mainMenu = new MainMenu(this, screen.getGame().assets);
		messageStack.add(mainMenu);
		if(camera != null) mainMenu.setCamera(camera);
	}
